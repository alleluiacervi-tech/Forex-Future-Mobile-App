          ...
          {setupTrial && (
            <View style={styles.section}>
              ...
              <Text variant="bodySmall" color={theme.colors.textSecondary} style={styles.sectionSubtitle}>
                No payment required now. You’ll choose a plan and pay via PayPal or card when your trial ends.
              </Text>
              ...
              <Card style={[styles.trialSummaryCard, { backgroundColor: theme.colors.surface, borderColor: theme.colors.border }]}>
                ...
                <Text variant="caption" color={theme.colors.textSecondary}>
                  7-day free trial. After the trial, choose a plan starting at ${selectedPrice}/{billingLabel}. Cancel anytime.
                </Text>
              </Card>

              <Button
                title={isLoading ? ‘Starting 7-day free trial...’ : ‘Start 7-Day Free Trial’}
